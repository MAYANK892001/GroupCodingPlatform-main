...
const MainHeading = ({ data }: { data?: MainHeadingData }) => {
    ...
    const [chatDisplayState, setChatDisplayState] = useState<boolean>(false);
    const [videoCallDisplayState, setVideoCallDisplayState] = useState<boolean>(false);
        ...
        <>
            <div className="fixed w-full h-[60px] bg-black border-b border-borders flex felx-row z-[100]">
                <Link to="/" className=" select-none">
                    ...
                    >
                        <span className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-red-600 px-[1px]">
                            Group
                        </span>
                        <span>Coding</span>
                    </div>
                ...
                {data?.status === "loggedin" || data?.status == undefined ? (
                    <div className="fixed flex flex-row right-[36px] items-center h-[60px]">
                        ...
                        <div className="flex items-center gap-2 px-[5px] text-[14px] text-[#808080]">
                            <Notification
                            ...
                            <ChatRequest
                                 ...
                                 displayFn={setChatDisplayState}
                            />
                            <VideoCall
                                display={videoCallDisplayState}
                                displayFn={setVideoCallDisplayState}
                     />

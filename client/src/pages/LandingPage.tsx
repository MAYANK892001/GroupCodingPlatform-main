    ...
    return (
        <div className="text-[14px] overflow-hidden h-screen">
            ...
            <div className="w-[100vw] overflow-hidden h-[calc(100vh-60px)] absolute">
                ...
                <div className="absolute circle-2-animation top-[8%] left-[45%] -translate-x-1/2 w-[500px] h-[500px] rounded-full filter blur-[99px] bg-gradient-to-br from-transparent to-blue-500 opacity-60 z-10"></div>
                <div className="absolute circle-3-animation top-[10%] left-[45%] -translate-x-1/2 w-[400px] h-[300px] rounded-full filter blur-[99px] bg-gradient-to-br from-transparent to-purple-600 opacity-60 z-10"></div>
                ...
                <div className="absolute circle-5-animation top-[10%] left-[45%] -translate-x-1/2 w-[400px] h-[400px] rounded-full filter blur-[99px] bg-gradient-to-br from-transparent to-blue-800 opacity-60 z-10"></div>
                <div className="absolute top-[20%] left-[47%] -translate-x-1/2 w-[600px] h-[500px] rounded-full filter blur-[99px] bg-gradient-to-br from-transparent to-blue-600 opacity-60 z-10"></div>
                <div className="absolute circle-7-animation top-[10%] left-[50%] -translate-x-1/2 w-[400px] h-[400px] rounded-full filter blur-[99px] bg-gradient-to-br from-transparent to-blue-800 opacity-60 z-10"></div>
            </div>
            {verifiedCertain && verified ? (
                <>
                ...
                <>
                    ...
                    <p className="absolute md:w-1/2 w-3/4 text-center mx-auto mt-[50px] z-50 inset-0 top-[300px]">
                        Group Coding platform help to achieve your
                        goals in coding journey. Solve problem
                        fastly and build good relation another coder. //Devloped By:Mayank//
                    </p>
